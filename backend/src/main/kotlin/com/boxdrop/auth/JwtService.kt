...
@Singleton
class JwtService(
    @Value("\${boxdrop.jwt.secret}") private val secret: String,
    @Value("\${boxdrop.jwt.access-token-expiry}") private val accessTokenExpiry: Long,
    @Value("\${boxdrop.jwt.refresh-token-expiry}") private val refreshTokenExpiry: Long
) {
